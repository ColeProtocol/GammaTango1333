...
export default function Comment({ 
  ...
  const [likeIconColor, setLikeColor] = useState(Colors.black);
  const [dislikeIconColor, setDislikeColor] = useState(Colors.black);
  ...
  function undoLike(currUserEmail) {
    try {
      Firebase.app()
        ...
        .then(() => {
          //alert("Your like on this comment has been removed.");
          Firebase.app().firestore().collection("users").doc(currUserEmail).update({
  ...
  function addDislike(currUserEmail) {
    try {
      Firebase.app()
        ...
        .then(() => {
          //alert("This comment has been disliked. We are sorry that you do not like this comment!");
          Firebase.app().firestore().collection("users").doc(currUserEmail).update({
  ...
  function undoDislike(currUserEmail) {
    try {
      Firebase.app()
        ...
        .then(() => {
          //alert("Your dislike on this comment has been removed.");
          Firebase.app().firestore().collection("users").doc(currUserEmail).update({
